gpu: BUILD/gpuMerge.o BUILD/gpuMain.o BUILD/main.o BUILD/RegionOfInterest.o BUILD/UcharSerialCamShift.o BUILD/timing.o
	nvcc -arch=sm_30 BUILD/gpuMerge.o BUILD/gpuMain.o BUILD/timing.o BUILD/RegionOfInterest.o BUILD/UcharSerialCamShift.o BUILD/main.o -o gpu `pkg-config opencv --cflags --libs` -lpthread
